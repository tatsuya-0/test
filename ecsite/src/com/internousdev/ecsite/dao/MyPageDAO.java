...
public class MyPageDAO {
	...
	public ArrayList<MyPageDTO> getMyPageUserInfo( String user_master_id)
		...
		String sql = "SELECT ubit.id,ubit.item_name,ubit.total_price,ubit.total_count,ubit.pay,ubit.insert_date FROM user_buy_item_transaction ubit LEFT JOIN item_info_transaction iit ON ubit.item_transaction_id=iit.id WHERE ubit.user_master_id=? ";
